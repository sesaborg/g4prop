...
namespace I3CLSimI3ParticleGeantConverter
{
    ...
    inline I3Particle::ParticleType ConvertPDGEncodingToI3ParticleType(int pdg_code)
    {
        ...
        case -2212:
            return I3Particle::PMinus;
        // case -2112:  return I3Particle::Hadrons; // NeutronBar
        case -321:
            return I3Particle::KMinus;
        case -311:
            return I3Particle::K0_Short; // not really right.. (K0)
        case -211:
        ...
        case 0:
            return I3Particle::unknown; // invalid
        case 11:
        ...
        case 22:
            return I3Particle::Gamma;
        case 111:
            return I3Particle::Pi0;
        case 130:
            return I3Particle::K0_Long;
        case 211:
            return I3Particle::PiPlus;
        case 310:
            return I3Particle::K0_Short;
        case 311:
            return I3Particle::K0_Long; // not really right.. (K0Bar)
        case 321:
        ...
        case 2112:
            return I3Particle::Neutron;
        case 2212:
            return I3Particle::PPlus;
        ...
        case 1000020040:
            return I3Particle::He4Nucleus;
        case 1000030070:
            return I3Particle::Li7Nucleus;
        case 1000040090:
            return I3Particle::Be9Nucleus;
        case 1000050110:
            return I3Particle::B11Nucleus;
        case 1000060120:
            return I3Particle::C12Nucleus;
        case 1000070140:
            return I3Particle::N14Nucleus;
        case 1000080160:
            return I3Particle::O16Nucleus;
        case 1000090190:
            return I3Particle::F19Nucleus;
        case 1000100200:
            return I3Particle::Ne20Nucleus;
        case 1000110230:
            return I3Particle::Na23Nucleus;
        case 1000120240:
            return I3Particle::Mg24Nucleus;
        case 1000130270:
            return I3Particle::Al27Nucleus;
        case 1000140280:
            return I3Particle::Si28Nucleus;
        case 1000150310:
            return I3Particle::P31Nucleus;
        case 1000160320:
            return I3Particle::S32Nucleus;
        case 1000170350:
            return I3Particle::Cl35Nucleus;
        case 1000180400:
            return I3Particle::Ar40Nucleus;
        case 1000190390:
            return I3Particle::K39Nucleus;
        case 1000200400:
            return I3Particle::Ca40Nucleus;
        case 1000210450:
            return I3Particle::Sc45Nucleus;
        case 1000220480:
            return I3Particle::Ti48Nucleus;
        case 1000230510:
            return I3Particle::V51Nucleus;
        case 1000240520:
            return I3Particle::Cr52Nucleus;
        case 1000250550:
            return I3Particle::Mn55Nucleus;
        case 1000260560:
            return I3Particle::Fe56Nucleus;

        default:
            return I3Particle::unknown; // invalid/unknown
        }
    }
    ...
    inline int ConvertI3ParticleTypeToPDGEncoding(I3Particle::ParticleType type)
    {
        ...
        case I3Particle::He4Nucleus:
            return 1000020040;
        case I3Particle::Li7Nucleus:
            return 1000030070;
        case I3Particle::Be9Nucleus:
            return 1000040090;
        case I3Particle::B11Nucleus:
            return 1000050110;
        case I3Particle::C12Nucleus:
            return 1000060120;
        case I3Particle::N14Nucleus:
            return 1000070140;
        case I3Particle::O16Nucleus:
            return 1000080160;
        case I3Particle::F19Nucleus:
            return 1000090190;
        case I3Particle::Ne20Nucleus:
            return 1000100200;
        case I3Particle::Na23Nucleus:
            return 1000110230;
        case I3Particle::Mg24Nucleus:
            return 1000120240;
        case I3Particle::Al27Nucleus:
            return 1000130270;
        case I3Particle::Si28Nucleus:
            return 1000140280;
        case I3Particle::P31Nucleus:
            return 1000150310;
        case I3Particle::S32Nucleus:
            return 1000160320;
        case I3Particle::Cl35Nucleus:
            return 1000170350;
        case I3Particle::Ar40Nucleus:
            return 1000180400;
        case I3Particle::K39Nucleus:
            return 1000190390;
        case I3Particle::Ca40Nucleus:
            return 1000200400;
        case I3Particle::Sc45Nucleus:
            return 1000210450;
        case I3Particle::Ti48Nucleus:
            return 1000220480;
        case I3Particle::V51Nucleus:
            return 1000230510;
        case I3Particle::Cr52Nucleus:
            return 1000240520;
        case I3Particle::Mn55Nucleus:
            return 1000250550;
        case I3Particle::Fe56Nucleus:
            return 1000260560;
        case I3Particle::CherenkovPhoton:
            return 0; // invalid
        ...
        case I3Particle::Brems:
            return 11; // NOTE: check these
        case I3Particle::DeltaE:
            return 11; // NOTE: check these
        case I3Particle::PairProd:
            return 22; // NOTE: check these
        case I3Particle::NuclInt:
            return 211; // we just assume these are pions
        case I3Particle::WeakInt:
            return 211; // we just assume these are pions
        case I3Particle::MuPair:
            return 22; // NOTE: check these
        case I3Particle::Hadrons:
            return 211; // we just assume these are pions
        case I3Particle::FiberLaser:
            return 0; // invalid
        case I3Particle::N2Laser:
            return 0; // invalid
        case I3Particle::YAGLaser:
            return 0; // invalid
    ...
    //         if (pdgcode == -2000001001)
    //             pdgcode = 11; // Brems    -> EMinus // NOTE: check these
    //         else if (pdgcode == -2000001002)
    //             pdgcode = 11; // DeltaE   -> EMinus // NOTE: check these
    //         else if (pdgcode == -2000001003)
    //             pdgcode = 22; // PairProd -> Gamma  // NOTE: check these
    //         else if (pdgcode == -2000001004)
    //             pdgcode = 211; // NuclInt  -> PiPlus (just assume this is a pion..)
    //         else if (pdgcode == -2000001005)
    //             pdgcode = 22; // MuPair   -> EMinus // NOTE: check these
    //         else if (pdgcode == -2000001006)
    //             pdgcode = 211; // Hadrons  -> PiPlus (just assume this is a pion..)
    //         else if (pdgcode == -2000001007)
    //             pdgcode = 211; // WeakInt  -> PiPlus (just assume this is a pion..)
